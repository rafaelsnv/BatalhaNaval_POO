...
public class testeImpressao {
    ...
    // No trabalho, o usuario vai escolher as posições ou vao ser criadas
    // aleatoriamente (caso seja bot)
    // Para esse exemplo, escolhi posições pré defenidas com base no vídeo que
    // usamos para entender sobre o jogo
